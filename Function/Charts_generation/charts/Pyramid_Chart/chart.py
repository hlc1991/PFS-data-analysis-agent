...
def generate(
    ...
    **kwargs
    ...
    age_col = mapping.get("age") or mapping.get("label") or age
    male_col = mapping.get("male") or mapping.get("left_value") or male
    female_col = mapping.get("female") or mapping.get("right_value") or female
