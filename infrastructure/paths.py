...
builds and explicit ``PFS_DATA_DIR`` runs use an OS user-data directory, so
...
APP_DIR_NAME = "PFSDataAnalysisAgent"
...
def resource_root() -> Path:
    override = _absolute_override("PFS_RESOURCE_DIR")
...
def data_root() -> Path:
    override = _absolute_override("PFS_DATA_DIR")
    if override is not None:
        return override
